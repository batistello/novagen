...
export const IntentionSchema = z.object({
  ...
  craft_item: z.string().nullable().optional(),
  item_key: z.string().nullable().optional(),
  equip_slot: z.enum(['hand', 'clothes']).nullable().optional(),
  target_wolf_id: z.coerce.number().nullable().optional(),
  target_rodent_id: z.coerce.number().nullable().optional(),
  target_object_id: z.coerce.number().nullable().optional(),
  medium_term_goal: z.string().nullable().optional(),
  long_term_goal: z.string().nullable().optional(),
  ...
  contract_response_id: z.coerce.number().nullable().optional(),
