...
export const IntentionSchema = z.object({
  ...
  thought: z.string(),
  emotion: z.string(),
  goal_type: z.enum(['explore', 'build', 'approach', 'move_away', 'observe', 'rest', 'collect', 'gather', 'drink', 'craft', 'fish', 'attack', 'equip', 'unequip', 'drop', 'give', 'attack_wolf', 'attack_rodent']),
  ...
  target_wolf_id: z.number().nullable().optional(),
  target_rodent_id: z.number().nullable().optional(),
